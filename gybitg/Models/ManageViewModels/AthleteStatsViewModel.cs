...
namespace gybitg.Models.ManageViewModels
{
    public class AthleteStatsViewModel
    {
        ...
        [Range(1, 200, ErrorMessage = "Points per Game must be 0 to 200")]
        [Display(Name = "Points per Game")]
        public decimal PPG { get; set; }

        [Range(1, 100, ErrorMessage = "Rebounds per Game must be 0 to 100")]
        [Display(Name = "Rebounds per Game")]
        public decimal RPG { get; set; }

        [Range(1, 100, ErrorMessage = "Assists per Game must be 0 to 100")]
        [Display(Name = "Assists per Game")]
        public decimal APG { get; set; }

        [Range(1, 100, ErrorMessage = "Games Played must be 0 to 100")]
        [Display(Name = "Games Played")]
        public int GP { get; set; }

        [Range(1, 100, ErrorMessage = "Games Sat must be 0 to 100")]
        [Display(Name = "Games Sat")]
        public int GS { get; set; }

        [Range(1, 100, ErrorMessage = "Average Minutes per Game must be 0 to 100")]
        [Display(Name = "Average Minutes per Game")]
        public decimal MPG { get; set; }

        [Range(1, 100, ErrorMessage = "Field Goals Attempted per Game must be 0 to 100")]
        [Display(Name = "Field Goals Attempted per Game")]
        public decimal FGAG { get; set; }

        [Range(1, 100, ErrorMessage = "Field Goals Made per Game must be 0 to 100")]
        ...
        [Range(1, 100, ErrorMessage = "Free Throws Attempted per Game must be 0 to 100")]
        [Display(Name = "Free Throws Attempted per Game")]
        public decimal FTAG { get; set; }

        [Range(1, 100, ErrorMessage = "Free Throws Made per Game must be 0 to 100")]
        ...
        [Range(1, 100, ErrorMessage = "Three Pointers Attempted per Game must be 0 to 100")]
        [Display(Name = "Three Pointers Attempted per Game")]
        public decimal TPAG { get; set; }

        [Range(1, 100, ErrorMessage = "Three Pointers Made per Game must be 0 to 100")]
